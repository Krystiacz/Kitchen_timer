...
#define	CYFRA_4		0x00 // address 00
#define	CYFRA_3		0x01 // address 01
#define	CYFRA_2		0x02 // address 02
#define	CYFRA_1		0x03 // address 03
...
void TM1637_blink_colon(bool value);
